 ...
 *
 */
public class MassPushVariant extends BaseModel {

    private static final long serialVersionUID = 2934112883233872813L;
    ...
    public void setNumberOfVariants(Long numberOfVariants) {
